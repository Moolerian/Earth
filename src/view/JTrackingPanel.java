...
public class JTrackingPanel extends javax.swing.JPanel
{
    ...
    public JTrackingPanel(Hashtable<String,AbstractSatellite> satHash,
                          Hashtable<String,GroundStation> gsHash,
                          String timeAsStringIn, Time currentJulianDate)
    {
...
// no good J2000 positions not saved through time right now in satprops
    ...
    private void initComponents() {
        ...
        jPolarPlotLabel = new util.JPolarPlotLabel();
    ...
    private void refreshComboBoxesButtonActionPerformed(java.awt.event.ActionEvent evt)
    //GEN-FIRST:event_refreshComboBoxesButtonActionPerformed
    ...
    private void objectChangeReset()
    {
        ...
        if (passTableModel != null) // ini of object
        {
            ...
            if (jPolarPlotLabel.isShowLeadLagData() && sat.getShowGroundTrack())
            {
                jPolarPlotLabel.setAerLead(AER.calculate_AER(new double[]{gs.getLatitude(),
                        gs.getLongitude(), gs.getAltitude()}, sat.getTemePosLead(), sat.getTimeLead()));
                jPolarPlotLabel.setAerLag(AER.calculate_AER(new double[]{gs.getLatitude(),
                        gs.getLongitude(), gs.getAltitude()}, sat.getTemePosLag(), sat.getTimeLag()));
            }
        }
...
//        }
    ...
    private util.JPolarPlotLabel jPolarPlotLabel;
